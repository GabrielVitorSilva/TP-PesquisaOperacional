...
# Função para obter a lista de ativos
def get_tickers():
    return ["AAPL", "MSFT", "GOOGL", "AMZN", "TSLA", "META", "NFLX", "NVDA"]

# Função para configurar o perfil de risco do investidor
...
# Função para obter os retornos esperados dos ativos
...
# Função para realizar a otimização de portfólio
...
# Interface de Seleção de Ativos e Parâmetros
...
# Processar Otimização se Ativos foram Selecionados
if selected_tickers:
    ...
    # Realizar otimização de portfólio
